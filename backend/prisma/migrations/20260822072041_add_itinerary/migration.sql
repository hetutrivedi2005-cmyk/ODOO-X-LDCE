...
-- CreateIndex
CREATE UNIQUE INDEX "PublicShare_shareToken_key" ON "PublicShare"("shareToken");
...
-- AddForeignKey
ALTER TABLE "ItineraryItem" ADD CONSTRAINT "ItineraryItem_tripStopId_fkey" FOREIGN KEY ("tripStopId") REFERENCES "TripStop"("id") ON DELETE SET NULL ON UPDATE CASCADE;
