...
const DeleteActivityModal = ({ isOpen, onClose, onConfirm, activityTitle, isDeleting }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl z-10 space-y-4 animate-scale-in">
        ...
        <div>
          <h3 className="text-lg font-bold text-white tracking-tight">Delete this activity?</h3>
          <p className="text-xs text-slate-400 mt-1 leading-relaxed">
            Are you sure you want to delete <span className="font-semibold text-slate-200">"{activityTitle}"</span>? This action cannot be undone and will remove it from your itinerary schedule.
          </p>
        </div>
